...
const HeaderTwo = ({variant}) => {
	...
	<div className="header__area three">
        <div className="container custom__container">
            ...
            <div className={`header__area-menubar three header__sticky ${ variant ? variant : "" } ${isSticky ? "header__sticky-sticky-menu" : ""}`}>
                <div className="header__area-menubar-left">
                    <div className="header__area-menubar-left-logo">
                        <Link href="/"><img src="/logo-1.png" alt="logo" /></Link>
                        <span className={mobileToggle ? "mobile-menu two mobile-menu-active" : "mobile-menu two"} onClick={() => setMobileToggle(!mobileToggle)}><span></span></span>
                    </div>
                </div>
                <div className="header__area-menubar-right three">
                    ...
                    <div className="header__area-menubar-right-box">
                        ...
                        <div className="header__area-menubar-right-sidebar">
                            <div className="header__area-menubar-right-sidebar-popup-icon three" onClick={() => setSidebarOpen(true)}><i className="fal fa-bars"></i></div>
                        </div>
                    </div>
                </div>
            </div>
